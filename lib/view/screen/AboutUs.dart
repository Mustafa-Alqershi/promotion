                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                          ...
                          children: [
                            Text(
                              'مرحبًا بك في تطبيق تواصل تنموي! ',
                              style: TextStyle(
                                fontFamily: 'NotoKufiArabic',
                                color: Colors.blue.shade900,
                                fontWeight: FontWeight.bold,
                            ...
                            Text(
                              '        نحن فخورون بتقديم تطبيق تواصل تنموي، الحل الحديث لتسجيل حضور الطلاب عبر الباركود. يهدف تطبيقنا إلى تبسيط وتحسين عملية تسجيل الحضور في المدارس والجامعات والمؤسسات التعليمية الأخرى. نحن ملتزمون بتوفير أداة قوية وموثوقة تساعد في تحسين كفاءة العملية التعليمية وتوفير الوقت والجهد للمعلمين والمدرسين والإداريين.',
